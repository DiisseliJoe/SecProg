...
#objcrypt encrypt and decrypt python object and JSON objects with AES CBC 32 Block Encryption

#salasana generointi?
# getpass kirjasto salasanaan 
...
def log_in():
    ...
    while True:
        ...
        if sanitized("yn","Do you want to try again y/n?: ") == "y":
            continue
        break       

#sanitazes user inputs. checks if username is taken and saves new user to json file.
def sign_in():
